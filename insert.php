...
if(isset($_POST['submit'])){
	...
	// $query="INSERT INTO proprety (name,monthly,address,access,floor,utility,descrip,images) VALUES ('$name','$monthly','$address','$access','$floor','$utility','$descrip','$temp_file')";
	$insert=$mysqli->query($query);
  //$query="INSERT into property(name) VALUES('121')";
	// mysql_query($query);
  $insert=$mysqli->query($query);
  if(!$insert)
  {
